...
import com.example.activitytest.DiaryCard;
...
public class DiaryCardAdapter extends RecyclerView.Adapter<DiaryCardAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final com.example.activitytest.PopOptionUtil mPop;
        ...
        holder.timeLineView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent intent = new Intent(mContext, com.example.activitytest.DiaryWriteActivity.class);
        ...
        mPop = new com.example.activitytest.PopOptionUtil(mContext);
        mPop.setOnPopClickEvent(new com.example.activitytest.PopClickEvent() {
