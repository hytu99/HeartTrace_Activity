...
public class StatisticsActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String range = "        您当前选择的日期范围:   "+now.get(Calendar.YEAR)+"/"+(now.get(Calendar.MONTH)+1)+"/"+(now.get(Calendar.DAY_OF_MONTH)-7)+" 至 "+now.get(Calendar.YEAR)+"/"+(now.get(Calendar.MONTH)+1)+"/"+ now.get(Calendar.DAY_OF_MONTH);
